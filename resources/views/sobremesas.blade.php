            ...
            <div class="col-md-8 text-center mt-3">
                ...
                <div class="container text-center">
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="{{ url('img/petit.png')}}" alt="" width="100%">
                        </div>
                        <div class="col">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="{{ url('img/brownie.png')}}" alt="" width="100%">
                        </div>
                        <div class="col">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="{{ url('img/sorvete.png')}}" alt="" width="100%">
                        </div>
                        <div class="col">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="{{ url('img/banoffee.png')}}" alt="" width="100%">
                        </div>
                        <div class="col">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-9.png" alt="" width="100%">
                        </div>
                        <div class="col">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-6.png" alt="" width="100%">
                        </div>
                        <div class="col">
