            ...
            <div class="col-md-8 text-center mt-3">
                ...
                <div class="container text-center">
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-21.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de 2 Queijos</h3>
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-10.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de 4 Queijos</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-1.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Pepperoni</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-7.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Frango com Catupiry</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-9.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Calabresa</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-6.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Muçarela</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-2.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de frango com cheddar</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-3.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Escondidinho de carne</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <h4>
                    <a href="http://127.0.0.1:8000/pizzas2">2</a>
                    <a href="http://127.0.0.1:8000/pizzas2"><i class="bi bi-arrow-right"></i></a>
                </h4>
