            ...
            <div class="col-md-8 col-sm-12 text-center mt-3">
                ...
                <div class="container text-center">
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/laranja.png" alt="" width="100%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Suco de Laranja</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                                Polpa de laranja e suco natural
                            </p>
                        ...
                        <div class="col">
                            ...
                            <select class="form-select" id="selecao">
                                ...
                                <option value="R$ 5.00">350 Ml</option>
                                <option value="R$ 10.00">700Ml</option>
                                <option value="R$ 17.00">1L</option>
                            </select>
                            <br>
                            <strong> Preço </strong><input disabled class="text-center border border-start-0" id="caixa1" style="width: 70px;" type="text" />
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/maracuja.png" alt="" width="100%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Suco de Maracuja</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                                Polpa de maracuja e suco natural
                            </p>
                            <button class="btn btn-success align-items-start" type="submit">
                                ADICIONAR AO CARRINHO
                            </button>
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/manga.png" alt="" width="100%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Suco de manga</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                                Polpa de manga e suco natural
                            </p>
                            <button class="btn btn-success align-items-start" type="submit">
                                ADICIONAR AO CARRINHO
                            </button>
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/morango.png" alt="" width="100%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Suco de morango</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                                Polpa de morango e suco natural
                            </p>
                            <button class="btn btn-success align-items-start" type="submit">
                                ADICIONAR AO CARRINHO
                            </button>
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pink.png" alt="" width="100%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pink lemonade</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                                Água, limão e  xarope de groselha
                            </p>
                            <button class="btn btn-success align-items-start" type="submit">
                                ADICIONAR AO CARRINHO
                            </button>
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/limao.png" alt="" width="100%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Limonada</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/coca-cola.png" alt="" width="50%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Coca-Cola</h3>
                            <div class="mt-5"></div>
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="{{ url('img/fanta-laranja.png')}}" alt="" width="50%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Fanta Laranja</h3>
                        </div>
                        <div class="col">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-4.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Carne seca com queijo</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-11.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza Baiana</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-13.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Atum com queijo</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <div class="container text-center">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            <img src="./img/pizza-14.png" alt="" width="80%">
                        </div>
                        <div class="col">
                            <h3 class="text-start">Pizza de Camarão com queijo</h3>
                            <h5 class="text-start">INGREDIENTES:</h5>
                            <p class="text-start">
                ...
                <h4>
                    <a href="http://127.0.0.1:8000/bebidas2">2</a>
                    <a href="http://127.0.0.1:8000/bebidas2"><i class="bi bi-arrow-right"></i></a>
                </h4>
